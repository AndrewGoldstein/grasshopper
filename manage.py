...
from grasshopper.database import db
from grasshopper.settings import DevConfig, ProdConfig
from grasshopper.user.models import User

CONFIG = ProdConfig if os.environ.get('GRASSHOPPER_ENV') == 'prod' else DevConfig
